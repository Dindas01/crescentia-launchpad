...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-br from-gray-50 to-blue-50 min-h-[calc(100vh-76px)] flex items-center">
      <div className="container-custom py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6 animate-fadeInUp animate-delay-200">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
              <Briefcase className="text-business-600 mb-4" size={32} />
              <h3 className="font-bold text-xl mb-2">Business Analysis</h3>
              <p className="text-gray-600">Identify opportunities and optimize processes</p>
            </div>
