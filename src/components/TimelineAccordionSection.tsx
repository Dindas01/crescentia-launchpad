...
const timelineSteps = [
  ...
  },
  {
    ...
    icon: FileText,
    items: [
      "Investment fee para iniciar trabalho",
      "Elaboração completa da candidatura",
      "Gestão de documentação",
      "Validações técnicas",
    ],
    highlight: "Pagas para começarmos",
  },
  {
    number: "3",
    ...
    icon: Send,
    items: [
      "Submissão na plataforma oficial",
      "Seguimento do processo",
      "Resposta a esclarecimentos",
      "Reuniões com entidades",
    ],
    highlight: "Incluído no investment fee",
  },
  {
    number: "4",
    ...
    icon: Eye,
    items: [
      "Notificação de aprovação oficial",
      "Success fee calculado sobre valor aprovado",
      "Apoio na fase de execução incluído",
      "Celebramos juntos! 🎉",
    ],
    highlight: "Pagas SÓ se aprovar",
  },
];
